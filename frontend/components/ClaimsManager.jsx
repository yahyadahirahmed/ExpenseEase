...
function ClaimsManager() {
    ...
    <div className='flex flex-col items-center mt-8'>
        <h1 className='text-3xl font-bold text-black mb-4'>Claim Management</h1>
        <div className="w-full max-w-4xl grid md:grid-cols-2 gap-4 overflow-auto" style={{ maxHeight: '600px' }}>
            {claims.map((claim, index) => (
                <div key={index} className="bg-gray-800 m-2 p-4 rounded-lg shadow">
                    ...
                    <div className="flex justify-between mt-2 text-gray-400">
                        ...
                        <p>Date: {format(new Date(claim.created), 'yyyy-MM-dd')}</p>
                    </div>
